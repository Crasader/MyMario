...
// 031. 创建角色，工厂类的创建函数，并非创建该类的对象，而是别的类对象
...
void Role::moveRight(float dt)
{}
void Role::moveLeft(float dt)
{}
void Role::moveUp(float dt)
{}
void Role::moveDown(float dt)
{}
...
#if 0
// 051. 判断某个点，在layerName对应的层中，是否有阻挡
